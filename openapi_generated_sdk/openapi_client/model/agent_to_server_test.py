...
class AgentToServerTest(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AgentToServerTest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            port (int): if protocol is TCP, defaults to port 80. Protocol and port (shown below) are mutually exclusive - if ICMP is selected and port is provided, the request will error.. [optional]  # noqa: E501
            server (str): target name or IP address. [optional]  # noqa: E501
        """
